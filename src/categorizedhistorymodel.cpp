...
HistoryTopLevelItem::~HistoryTopLevelItem() {
   const int idx = CategorizedHistoryModel::instance().d_ptr->m_lCategoryCounter.indexOf(this);
   if (idx != -1)
      CategorizedHistoryModel::instance().d_ptr->m_lCategoryCounter.remove(idx);
