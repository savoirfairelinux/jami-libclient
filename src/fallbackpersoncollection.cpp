...
{
   return Interfaces::pixmapManipulator().collectionIcon(this,Interfaces::PixmapManipulatorI::CollectionIconHint::CONTACT);
}
...
bool FallbackPersonCollection::isEnabled() const
{
    ...
    try {
        return Interfaces::itemModelStateSerializer().isChecked(this);
    } catch (...) {
        return true;
     }
}
