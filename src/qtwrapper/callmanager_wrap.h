        ...
        callHandlers = {
            ...
            exportable_callback<CallSignal::ConferenceCreated>(
                [this](const std::string& accountId, const std::string& confId) {
                    LOG_DRING_SIGNAL("conferenceCreated",
                                     QString(accountId.c_str()),
...
public Q_SLOTS: // METHODS
    ...
    bool addParticipant(const QString& accountId, const QString& callId, const QString& confId)
    {
    ...
    bool joinConference(const QString& accountId, const QString& sel_confId, const QString& drag_confId)
    {
    ...
    bool joinParticipant(const QString& accountId, const QString& sel_callId, const QString& drag_callId)
    {
    ...
    bool answerMediaChangeRequest(const QString& accountId, const QString& callId, const VectorMapStringString& mediaList)
    {
    ...
    void sendTextMessage(const QString& accountId, const QString& callId, const QMap<QString, QString>& message, bool isMixed)
    {
    ...
    void muteParticipant(const QString& accountId, const QString& confId, const QString& peerId, const bool& state)
    {
    ...
    void hangupParticipant(const QString& accountId, const QString& confId, const QString& participant)
    {
