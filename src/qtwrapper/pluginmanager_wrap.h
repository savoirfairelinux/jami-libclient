...
public Q_SLOTS: // METHODS
    ...
    MapStringString isToggledMediaHandler()
    {
        MapStringString temp =
            convertMap(DRing::isToggledMediaHandler());
        return temp;
    }
    ...
    void saveStateLoadedPlugins(const QString& path, bool loaded)
    {
        return DRing::saveStateLoadedPlugins(path.toStdString(), loaded);
    }
