...
public Q_SLOTS: // METHODS
    ...
    QStringList getLastMessages(const QString& accountID, const uint64_t& base_timestamp) {
        return convertStringList(DRing::getLastMessages(accountID.toStdString(), base_timestamp));
    }
