    ...
    ConfigurationManagerInterface() {
        ...
        confHandlers = {
            ...
            exportable_callback<ConfigurationSignal::ActiveCodecListChanged>(
                [this] (const std::string& account_id, std::vector<unsigned> activated_codecs) {
                    Q_EMIT this->activeCodecListChanged(QString(account_id.c_str()), QVector<unsigned>::fromStdVector(activated_codecs));
                }),
        };
