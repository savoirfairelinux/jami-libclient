...
public Q_SLOTS: // METHODS
    ...
    std::vector<Message> getLastMessages(const QString& accountID, const uint64_t& base_timestamp) {
        return DRing::getLastMessages(accountID.toStdString(), base_timestamp);
    }
