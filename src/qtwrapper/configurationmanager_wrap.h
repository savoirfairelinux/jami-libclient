...
public Q_SLOTS: // METHODS
    ...
    QVector<DRing::Message> getLastMessages(const QString& accountID, const uint64_t& base_timestamp) {
        return QVector<DRing::Message>::fromStdVector(DRing::getLastMessages(accountID.toStdString(), base_timestamp));
    }
