...
public Q_SLOTS: // METHODS
   ...
   void sendTrustRequest(const QString& accountId, const QString& from, const QMap<QString, QString>& payload)
   {
...
Q_SIGNALS: // SIGNALS
   ...
   void incomingTrustRequest(const QString& accountId, const QString& from, const QMap<QString, QString>& payload, qulonglong timeStamp);
