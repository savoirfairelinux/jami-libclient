...
void VideoRendererManager::stopLocalRecorder(const size_t id) const
{
   VideoManagerInterface& interface = VideoManager::instance();
   instance.stopLocalRecorder(id);
}

size_t VideoRendererManager::startLocalRecorder() const
{
   VideoManagerInterface& interface = VideoManager::instance();
   return instance.startLocalRecorder();
}

std::string VideoRendererManager::getLocalRecorderFilename(size_t id) const
{
   VideoManagerInterface& interface = VideoManager::instance();
   return instance.getLocalRecorderFilename(id);
}
