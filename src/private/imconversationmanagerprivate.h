...
private Q_SLOTS:
   void newMessage       (const QString& callId   , const QString& from, const QMap<QString,QString>& payloads, const qint64 timestamp);
   void newAccountMessage(const QString& accountId, const QString& from, const QMap<QString,QString>& payloads, const qint64 timestamp);
