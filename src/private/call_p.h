...
public:
   ...
   **/
   ...
   Matrix2D<LRCMedia::Media::Type, LRCMedia::Media::Direction, QList<LRCMedia::Media*>* > m_mMedias;

   Matrix2D<LRCMedia::Media::Type, LRCMedia::Media::Direction, QList<LRCMedia::Recording*>* > m_mRecordings;

   Matrix2D<LRCMedia::Media::Type, LRCMedia::Media::Direction, bool > m_mIsRecording;
   ...
   template<typename T>
   T* mediaFactory(LRCMedia::Media::Direction dir);
