...
#pragma GCC diagnostic ignored "-pedantic"
   const char data[]     ; /*!< the whole shared memory                                      */
...
bool ShmRendererPrivate::getNewFrame(bool wait)
{
   ...
   q_ptr->Video::Renderer::d_ptr->m_pFrame.setRawData(m_pShmArea->data + m_pShmArea->readOffset,
...
QByteArray ShmRenderer::currentFrame() const
{
    if (not isRendering())
        return {};
