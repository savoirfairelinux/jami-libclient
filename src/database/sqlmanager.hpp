...
bool SqlManager::createTable() const {
    ...
    if (std::is_same<T, Call>::value) {
        createQuery.prepare(QString("CREATE TABLE IF NOT EXISTS %1 (%2 TEXT UNIQUE, %3 TEXT, %4 TEXT, %5 TEXT, %6 TEXT, %7 TEXT, %8 TEXT, %9 INTEGER, %10 INTEGER, %11 TEXT, %12 TEXT, %13 TEXT)")
        .arg(getTableName<T>())
