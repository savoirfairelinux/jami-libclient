...
HistoryTimeCategoryModel* HistoryTimeCategoryModelPrivate::m_spInstance = new HistoryTimeCategoryModel();
...
QString HistoryTimeCategoryModel::timeToHistoryCategory(const time_t time)
{
   ...
   if (period >= 0 && period <= 24)
      return HistoryTimeCategoryModelPrivate::m_spInstance->d_ptr->m_lCategories[period];
   else
      return HistoryTimeCategoryModelPrivate::m_spInstance->d_ptr->m_lCategories[24];
}
...
{
   if (idx > 24) return HistoryTimeCategoryModelPrivate::m_spInstance->d_ptr->m_lCategories[24];
   return HistoryTimeCategoryModelPrivate::m_spInstance->d_ptr->m_lCategories[idx];
}
