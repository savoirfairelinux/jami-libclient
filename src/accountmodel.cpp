...
void AccountModelPrivate::slotRegisteredNameFound(const QString& accountId, const QString& address, const QString& name)
{
   ...
   emit a->registeredNameFound(address, name);
}
