...
{
public:
   explicit LocalTextRecordingCollection(CollectionMediator<LRCMedia::Recording>* mediator);
   ...
   LRCMedia::TextRecording* fetchFor (const ContactMethod* cm);
   LRCMedia::TextRecording* createFor(const ContactMethod* cm);
