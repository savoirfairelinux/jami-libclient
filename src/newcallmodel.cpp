...
NewCallModel::setActiveStream(const QString& confId,
                              ...
                              bool state)
{
    CallManager::instance().setActiveStream(owner.id, confId, accountUri, deviceId, sinkId, state);
}
...
NewCallModel::muteStream(const QString& confId,
                         ...
                         const bool& state)
{
    CallManager::instance().muteStream(owner.id, confId, accountUri, deviceId, sinkId, state);
}
