...
public:
     ...
     *
     * nb: usually the identifiers has to be the same between bindCol and bindsSet
     */
     ...
     *
     * nb: usually, identifiers between set and bindsSet, are equals. The same goes between where and bindsWhere.
     */
     ...
     * begin by ':'. The value is the value test.
     *
     * nb: usually, identifiers between where and bindsWhere, are equals.
     */
