...
public:
     ...
     * @note nbrOfCols store the number of columns returned.
     * @note payloads store the values. if nbrOfCols equals three and if the size of payloads equals six, means two rows of
