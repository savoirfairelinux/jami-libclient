...
public:
   ///Hint the implementation how to soft/filter the persons
   enum class SelectPersonHint {
      NONE = 0x0 << 0
      // Will be used eventually, let's avoid breaking the API
   };

   ///Hint the implementation how to soft/filter the contact methods
   ...
   virtual Person* selectPerson(FlagPack<SelectPersonHint> hints = SelectPersonHint::NONE) const = 0;
   virtual ContactMethod* selectContactMethod(FlagPack<SelectContactMethodHint> hints = SelectContactMethodHint::NONE) const = 0;
};
