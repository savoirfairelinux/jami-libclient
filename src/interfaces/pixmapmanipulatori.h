...
public:
    ...
    virtual QVariant   conversationPhoto(const lrc::conversation::Info& conversation,
    ...
    virtual QVariant   decorationRole(const lrc::conversation::Info& c,
                                      const lrc::ContactModel& contactModel) = 0;
