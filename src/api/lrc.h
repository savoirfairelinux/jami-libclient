...
public:
    ...
    /**
     * whether the given account has any notifications
     */
    bool hasNotifications(const QString& accountId);
    ...
    /**
     * remove existing notifications for the given acccount
     */
    void removeNotifications(const QString& accountId);
