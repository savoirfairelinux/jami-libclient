...
public:
    ...
    void registerTransferId(long long dringId, const QString& interactionId);

    QString getInteractionIdFromDringId(long long dringId);

    long long getDringIdFromInteractionId(const QString& interactionId);
