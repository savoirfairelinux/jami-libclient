...
Q_SIGNALS:
    ...
    /**
     * Emitted when the client should ask the user whether he wants to let a message after a failed call.
     */
    void showLetMessageView(const std::string& accountId, const api::conversation::Info& conversationInfo) const;
    /**
