...
public:
     ...
     */
    Q_INVOKABLE VectorString getDevices() const;
    /**
     ...
     */
    Q_INVOKABLE VectorString getAudioOutputDevices() const;
    /**
     * Get current audio inputs
     * @return audio inputs
     */
    Q_INVOKABLE VectorString getAudioInputDevices() const;
    /**
     ...
     * @ param device name
     */
    Q_INVOKABLE void setCurrentVideoCaptureDevice(QString &currentVideoCaptureDevice);
     /**
     * set current using device
