...
class SearchResultListPimpl;

/**
 *  @brief Represent the temporary item
 */
class LIB_EXPORT SearchResultList : public Collection {
    Q_OBJECT
public:

    SearchResultList(const QString& owner);
    ~SearchResultList();
...
private:
    std::unique_ptr<SearchResultListPimpl> pimpl_;
};
