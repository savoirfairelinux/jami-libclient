...
public:
     ...
     */
    void setActiveSink(const QString& confId, const QString& accountUri, const QString& deviceId, const QString& sinkId, bool state);
     ...
     * @param sinkId        Sink Id of the participant to mute
     * @param state         State of the change (true mute participant / false unmute participant)
     */
    void muteSinkAudio(const QString& confId,
                       const QString& accountUri,
                       const QString& deviceId,
    ...
    /**
     * Kick device from the conference
     * @param confId        The call to change
     * @param accountUri    Uri of the participant to mute
     * @param deviceId      Device Id of the participant to mute
     */
    void kickDevice(const QString& confId, const QString& accountUri, const QString& deviceId);
