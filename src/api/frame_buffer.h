...
using FrameBufferBase = DRing::FrameBufferBase;
using FrameBufferBasePtr = DRing::SinkTarget::FrameBufferBasePtr;
...
using FrameBufferBasePtr = std::unique_ptr<lrc::api::video::FrameBufferBase>;
#endif