...
Q_SIGNALS:
    ...
    // [jn] we have to move these signals :
    void showChatView(const conversation::Info& conversationInfo) const;
    void showCallView(const conversation::Info& conversationInfo) const;
    void showIncomingCallView(const conversation::Info& conversationInfo) const;
