...
public:
    ...
    std::map<long long, QString> dring2lrcIdMap;
    std::map<QString, long long> lrc2dringIdMap; // stricly the reverse map of dring2lrcIdMap
};
...
void
DataTransferModel::registerTransferId(long long dringId, const QString& interactionId)
{
