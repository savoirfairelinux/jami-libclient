...
public:
    ...
    MapStringString dring2lrcIdMap;
    MapStringString lrc2dringIdMap; // stricly the reverse map of dring2lrcIdMap
};
...
{
    pimpl_->dring2lrcIdMap[fileId] = interactionId;
                          ...
                          std::size_t offset)
{
    ...
    auto dring_id = pimpl_->lrc2dringIdMap[interactionId];
...
QString
DataTransferModel::getInteractionIdFromDringId(const QString& fileId)
{
    return pimpl_->dring2lrcIdMap[fileId];
}

QString
DataTransferModel::getDringIdFromInteractionId(const QString& interactionId)
{
    return pimpl_->lrc2dringIdMap[interactionId];
}
