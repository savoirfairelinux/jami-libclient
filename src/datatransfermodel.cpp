...
void
DataTransferModel::transferInfo(const QString& accountId, const QString& conversationId, DataTransferId ringId, datatransfer::Info& lrc_info)
{
...
void
DataTransferModel::bytesProgress(const QString& accountId, const QString& conversationId, const QString& interactionId, int64_t& total, int64_t& progress)
{
    ConfigurationManager::instance()
        ...
        .dataTransferBytesProgress(accountId, conversationId, pimpl_->lrc2dringIdMap.at(interactionId),
                                   reinterpret_cast<DataTransferId&>(total),
                                   reinterpret_cast<DataTransferId&>(progress));
#endif
}

QString
DataTransferModel::accept(const QString& accountId, const QString& conversationId, const QString& interactionId, const QString& file_path, std::size_t offset)
{
