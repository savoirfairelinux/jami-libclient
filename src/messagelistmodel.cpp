...
void
MessageListModel::addHyperlinkInfo(QString messageId, QVariantList hyperlinkInformation)
{
    int index = getIndexOfMessage(messageId);
    QModelIndex modelIndex = QAbstractListModel::index(index, 0);

    atIndex(index).second.hyperlinkPreviewInformation = hyperlinkInformation;
