...
public:
   ...
   private Q_SLOTS:
      ...
      void slotSmartInfo          ( MapStringString  info                             );
};
...
void CallModelPrivate::init()
{
    ...
    /**/connect(&callManager, SIGNAL(SmartInfo(MapStringString))              , this , SLOT(slotSmartInfo(MapStringString)));
    /*                                                                                                                           */
 ...
 ****************************************************************************/
 ...
 void CallModelPrivate::slotSmartInfo(MapStringString info)
 {
   SmartInfoHub::instance().setMapInfo(info);
   emit q_ptr->updateInfo(info);
