...
public:
   ...
   private Q_SLOTS:
      ...
      void slotSmartInfo          ( const QMap<QString, QString>& info                             );
};
...
void CallModelPrivate::init()
{
    ...
    /**/connect(&callManager, SIGNAL(SmartInfo(QMap<QString, QString>))       , this , SLOT(slotSmartInfo(QMap<QString, QString>)));
    /*                                                                                                                           */
 ...
 ****************************************************************************/
 ...
 void CallModelPrivate::slotSmartInfo(const QMap<QString, QString>& info)
 {
   //Q_UNUSED(info)
   qDebug() << "Send signal from callmodel";
   //SmartInfoHub::setAnswer(val);
   //emit q_ptr->updateInfo(val);
