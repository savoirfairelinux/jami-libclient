...
timestamp text, is_unread boolean, is_outgoing boolean, type text, \
status text)";
...
DATABASE_UPDATE_CONTACT(const std::string& ring_id,
                        const std::string& new_username)
{
    return "UPDATE contacts SET username='" + new_username
    + "' WHERE ring_id='" + ring_id + "'";
}

static const std::string
DATABASE_GET_CONTACT_ATTRIBUTE(const std::string& ring_id,
                               const std::string& attribute)
{
    return "SELECT " + attribute + " FROM contacts WHERE ring_id='"
    + ring_id + "'";
}
...
static const std::string
DATABASE_COUNT_MESSAGES_UNREAD(const std::string& account_id,
...
static const std::string
DATABASE_GET_MESSAGES(const std::string& account_id,
                      const std::string& contact_id)
{
...
static const std::string
DATABASE_REMOVE_HISTORY(const std::string& account_id,
                        const std::string& contact_id)
{
