...
// This following global is not subject of global initialization order fiasco, has the class
// is not exposed outside of this compilation unit, AND, the global that uses it (AvailableAccountModel)
// is also protected against the same problem.
