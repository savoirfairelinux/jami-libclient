...
public Q_SLOTS:
     ...
     */
    void slotNewAccountTransfer(qulonglong dringId, datatransfer::Info info);
...
void
ContactModelPimpl::slotNewAccountTransfer(qulonglong dringId, datatransfer::Info info)
{
