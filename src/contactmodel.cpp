...
public Q_SLOTS:
     ...
     * @param vCard
     */
    void slotVCardReceived(const QString& accountId, const QString& peer, const QString& vCard);
};
...
, callbacksHandler(callbacksHandler)
{
    ...
    connect(&ConfigurationManager::instance(), &ConfigurationManagerInterface::vCardReceived,
            this, &ContactModelPimpl::slotVCardReceived);
}
...
ContactModelPimpl::~ContactModelPimpl()
{
    ...
    disconnect(&callbacksHandler, &CallbacksHandler::transferStatusCreated,
               this, &ContactModelPimpl::slotNewAccountTransfer);
    disconnect(&ConfigurationManager::instance(), &ConfigurationManagerInterface::vCardReceived,
               this, &ContactModelPimpl::slotVCardReceived);
}
...
void
ContactModelPimpl::slotVCardReceived(const QString& accountId, const QString& peer, const QString& vCard)
{
    if (accountId != linked.owner.id) return;
    ...
    // TODO do that from callbackshandler
