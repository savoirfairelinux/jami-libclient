...
void
Database::addMessage(const std::string& account, const message::Info& message) const
{
...
MessagesMap
Database::getAllMessages(const std::string& account, const std::string& uid) const
{
