...
void
NewAccountModel::addNewSIPAccount()
{
    MapStringString details = ConfigurationManager::instance().getAccountTemplate("SIP");
    using namespace DRing::Account;
    details[ConfProperties::TYPE] = "SIP";
    ConfigurationManager::instance().addAccount(details);
}
