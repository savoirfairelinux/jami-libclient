...
NewAccountModel::NewAccountModel(const Database& database, const CallbacksHandler& callbackHandler)
: QObject()
...
, database(database)
{
    ...
    for (auto& id : accountIds) {
        ...
        owner.contactModel = std::make_unique<ContactModel>(owner, database, callbackHandler);
