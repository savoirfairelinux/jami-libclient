                                  ...
                                  const account::ConfProperties_t& confProperties) const
{
    ...
    auto& acccountInfo = accountInfoEntry->second;
    ...
    details[ConfProperties::ENABLED]                    = toQString(acccountInfo.enabled);
    details[ConfProperties::ALIAS]                      = toQString(acccountInfo.profileInfo.alias);
    details[ConfProperties::TYPE]                       = toQString(acccountInfo.enabled);
    details[ConfProperties::USERNAME]                   = toQString(acccountInfo.profileInfo.uri).prepend((acccountInfo.profileInfo.type == profile::Type::RING) ? "ring:" : "");
