...
void
CallbacksHandler::slotActiveCodecListChanged(const QString& accountId, QVector<unsigned> activated_codecs)
{
    emit activeCodecListChanged(accountId.toStdString(), activated_codecs.toStdVector());
}
