...
void
CallbacksHandler::slotVoiceMailNotify(const QString& accountId, int newVM, int oldVM, int newUrgentVM)
{
    emit voiceMailNotify(accountId.toStdString(), newVM, oldVM, newUrgentVM);
}
