...
void CallPrivate::sendProfile()
{
    ...
    std::string photo = "";//authority::storage::getAvatarForProfileId(db, accountProfileId);
    std::string alias = "";//authority::storage::getAliasForProfileId(db, accountProfileId);
