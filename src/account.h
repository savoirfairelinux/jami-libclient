...
//    Q_PROPERTY(QString        typeName                     READ type                          WRITE setType                        )
   ...
   public:
      ...
      enum class Role {
         Alias                       = static_cast<int>(::Role::UserRole) + 100,
         Proto                       = static_cast<int>(::Role::UserRole) + 101,
         Hostname                    = static_cast<int>(::Role::UserRole) + 102,
         Username                    = static_cast<int>(::Role::UserRole) + 103,
         Mailbox                     = static_cast<int>(::Role::UserRole) + 104,
         Proxy                       = static_cast<int>(::Role::UserRole) + 105,
         TlsPassword                 = static_cast<int>(::Role::UserRole) + 107,
         TlsCaListCertificate        = static_cast<int>(::Role::UserRole) + 108,
         TlsCertificate              = static_cast<int>(::Role::UserRole) + 109,
         TlsPrivateKey               = static_cast<int>(::Role::UserRole) + 110,
         TlsServerName               = static_cast<int>(::Role::UserRole) + 112,
         SipStunServer               = static_cast<int>(::Role::UserRole) + 113,
         PublishedAddress            = static_cast<int>(::Role::UserRole) + 114,
         RingtonePath                = static_cast<int>(::Role::UserRole) + 116,
         RegistrationExpire          = static_cast<int>(::Role::UserRole) + 118,
         TlsNegotiationTimeoutSec    = static_cast<int>(::Role::UserRole) + 119,
         TlsNegotiationTimeoutMsec   = static_cast<int>(::Role::UserRole) + 120,
         LocalPort                   = static_cast<int>(::Role::UserRole) + 121,
         BootstrapPort               = static_cast<int>(::Role::UserRole) + 122,
         PublishedPort               = static_cast<int>(::Role::UserRole) + 123,
         Enabled                     = static_cast<int>(::Role::UserRole) + 124,
         AutoAnswer                  = static_cast<int>(::Role::UserRole) + 125,
         TlsVerifyServer             = static_cast<int>(::Role::UserRole) + 126,
         TlsVerifyClient             = static_cast<int>(::Role::UserRole) + 127,
         TlsRequireClientCertificate = static_cast<int>(::Role::UserRole) + 128,
         TlsEnabled                  = static_cast<int>(::Role::UserRole) + 129,
         DisplaySasOnce              = static_cast<int>(::Role::UserRole) + 130,
         SrtpRtpFallback             = static_cast<int>(::Role::UserRole) + 131,
         ZrtpDisplaySas              = static_cast<int>(::Role::UserRole) + 132,
         ZrtpNotSuppWarning          = static_cast<int>(::Role::UserRole) + 133,
         ZrtpHelloHash               = static_cast<int>(::Role::UserRole) + 134,
         SipStunEnabled              = static_cast<int>(::Role::UserRole) + 135,
         PublishedSameAsLocal        = static_cast<int>(::Role::UserRole) + 136,
         RingtoneEnabled             = static_cast<int>(::Role::UserRole) + 137,
         dTMFType                    = static_cast<int>(::Role::UserRole) + 138,
         Id                          = static_cast<int>(::Role::UserRole) + 139,
         Object                      = static_cast<int>(::Role::UserRole) + 140,
         TypeName                    = static_cast<int>(::Role::UserRole) + 141,
         PresenceStatus              = static_cast<int>(::Role::UserRole) + 142,
         PresenceMessage             = static_cast<int>(::Role::UserRole) + 143,
         RegistrationState           = static_cast<int>(::Role::UserRole) + 144,
         UseDefaultPort              = static_cast<int>(::Role::UserRole) + 145,
         UsedForOutgogingCall        = static_cast<int>(::Role::UserRole) + 146,
         TotalCallCount              = static_cast<int>(::Role::UserRole) + 147,
         WeekCallCount               = static_cast<int>(::Role::UserRole) + 148,
         TrimesterCallCount          = static_cast<int>(::Role::UserRole) + 149,
         LastUsed                    = static_cast<int>(::Role::UserRole) + 150,
         UserAgent                   = static_cast<int>(::Role::UserRole) + 153,
         Password                    = static_cast<int>(::Role::UserRole) + 154,
         SupportPresencePublish      = static_cast<int>(::Role::UserRole) + 155,
         SupportPresenceSubscribe    = static_cast<int>(::Role::UserRole) + 156,
         PresenceEnabled             = static_cast<int>(::Role::UserRole) + 165,
         IsVideoEnabled              = static_cast<int>(::Role::UserRole) + 169,
         VideoPortMax                = static_cast<int>(::Role::UserRole) + 157,
         VideoPortMin                = static_cast<int>(::Role::UserRole) + 158,
         AudioPortMin                = static_cast<int>(::Role::UserRole) + 159,
         AudioPortMax                = static_cast<int>(::Role::UserRole) + 160,
         IsUpnpEnabled               = static_cast<int>(::Role::UserRole) + 161,
         HasCustomUserAgent          = static_cast<int>(::Role::UserRole) + 162,
         LastTransportErrorCode      = static_cast<int>(::Role::UserRole) + 163,
         LastTransportErrorMessage   = static_cast<int>(::Role::UserRole) + 164,
         TurnServer                  = static_cast<int>(::Role::UserRole) + 168,
         TurnServerEnabled           = static_cast<int>(::Role::UserRole) + 194,
         TurnServerUsername          = static_cast<int>(::Role::UserRole) + 195,
         TurnServerPassword          = static_cast<int>(::Role::UserRole) + 196,
         TurnServerRealm             = static_cast<int>(::Role::UserRole) + 197,
         HasProxy                    = static_cast<int>(::Role::UserRole) + 170,
         DisplayName                 = static_cast<int>(::Role::UserRole) + 171,
         SrtpEnabled                 = static_cast<int>(::Role::UserRole) + 172,
         HasCustomBootstrap          = static_cast<int>(::Role::UserRole) + 173,
         CredentialModel             = static_cast<int>(::Role::UserRole) + 174,
         CodecModel                  = static_cast<int>(::Role::UserRole) + 175,
         KeyExchangeModel            = static_cast<int>(::Role::UserRole) + 176,
         CipherModel                 = static_cast<int>(::Role::UserRole) + 177,
         StatusModel                 = static_cast<int>(::Role::UserRole) + 178,
         SecurityEvaluationModel     = static_cast<int>(::Role::UserRole) + 179,
         TlsMethodModel              = static_cast<int>(::Role::UserRole) + 180,
         ProtocolModel               = static_cast<int>(::Role::UserRole) + 181,
         BootstrapModel              = static_cast<int>(::Role::UserRole) + 182,
         NetworkInterfaceModel       = static_cast<int>(::Role::UserRole) + 183,
         KnownCertificateModel       = static_cast<int>(::Role::UserRole) + 184,
         BannedCertificatesModel     = static_cast<int>(::Role::UserRole) + 185,
         AllowedCertificatesModel    = static_cast<int>(::Role::UserRole) + 186,
         AllowIncomingFromHistory    = static_cast<int>(::Role::UserRole) + 187,
         AllowIncomingFromContact    = static_cast<int>(::Role::UserRole) + 188,
         AllowIncomingFromUnknown    = static_cast<int>(::Role::UserRole) + 189,
         ActiveCallLimit             = static_cast<int>(::Role::UserRole) + 190,
         HasActiveCallLimit          = static_cast<int>(::Role::UserRole) + 191,
         SecurityLevel               = static_cast<int>(::Role::UserRole) + 192,
         SecurityLevelIcon           = static_cast<int>(::Role::UserRole) + 193,
