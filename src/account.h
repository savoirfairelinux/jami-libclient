...
//    Q_PROPERTY(QString        typeName                     READ type                          WRITE setType                        )
   ...
   Q_SIGNALS:
      ...
      void nameRegistrationEnded(Account::RegisterNameStatus status, const QString& name);
      ///Name or address lookup has completed
      void registeredNameFound(Account::LookupStatus status, const QString& address, const QString& name);
};
