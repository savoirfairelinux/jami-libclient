...
PluginModel::getPluginPreferences(const QString& path, const QString& accountId, const QString& lang)
{
    return PluginManager::instance().getPluginPreferences(path, accountId, lang);
}
