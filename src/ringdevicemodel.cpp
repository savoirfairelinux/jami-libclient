...
public:
   ...
   void reload();
   void reload(QStringList accountDevices);
   void clearLines();
...
void RingDeviceModelPrivate::reload(QStringList accountDevices)
{
    clearLines();
...
void RingDeviceModel::reload( const QStringList& accountDevices )
{
