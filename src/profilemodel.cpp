...
Profile* ProfileModel::getProfileById(const QByteArray& id)
{
...
QModelIndex ProfileModelPrivate::addProfile(Person* person, const QString& name)
{
   ...
   if (person) {
      auto profile = new Profile(q_ptr, person);
      ...
      auto profile = new Profile(this, new Person(this));
