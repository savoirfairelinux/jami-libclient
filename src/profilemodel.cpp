...
{
    if (getDelegateManager()->getProfilePersisterDelegate()) {
...
#endif
                const auto& profilesDir = getDelegateManager()->getProfilePersisterDelegate()->getProfilesDir();
...
void ProfileContentBackend::loadProfiles()
{
   if (getDelegateManager()->getProfilePersisterDelegate()) {
      ...
      const QDir profilesDir = getDelegateManager()->getProfilePersisterDelegate()->getProfilesDir();
