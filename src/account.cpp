...
bool Account::registerName(const QString& password, const QString& name) const
{
    ...
    return true; //TODO: maybe registerName should return a bool?
}

//Lookup a name
bool Account::lookupName(const QString& name) const
{
    ConfigurationManager::instance().lookupName(id(), name);
    return true; //TODO: maybe lookupName should return a bool?
}

//Lookup an address
bool Account::lookupAddress(const QString& address) const
{
    ConfigurationManager::instance().lookupAddress(id(), address);
    return true; //TODO: maube lookupAddress should return a bool?
}
