...
{
public:
   LocalBookmarkEditor(CollectionMediator<ContactMethod>* m) : CollectionEditor<ContactMethod>(m),m_Tracked(false) {}
...
{
   QFile file(QStandardPaths::writableLocation(QStandardPaths::DataLocation) + QLatin1Char('/') +LocalBookmarkCollectionPrivate::FILENAME);
...
{
   return QFile::remove(QStandardPaths::writableLocation(QStandardPaths::DataLocation) + QLatin1Char('/') + LocalBookmarkCollectionPrivate::FILENAME);
}
