...
public:
   ...
   Q_INVOKABLE const QByteArray toVCard(QList<Account*> accounts = {}, const std::string& avatar = "", const std::string& newName = "", bool compressImage = false) const;
   Q_INVOKABLE const QByteArray toVCard(bool compressImage) const;
