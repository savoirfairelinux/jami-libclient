...
public:
     ...
     */
    bool sortConversations(const conversation::Info& convA, const conversation::Info& convB);
    /**
...
ConversationModel::sendMessage(const QString& uid, const QString& body)
{
    try {
        ...
        auto cb = std::function<void(QString)>([this, isTemporary, body, &conversation](
            ...
            pimpl_->customFilteredConversations.invalidate();
            ...
            // this will be done in getAllFilteredConversations ???
    ...
    , behaviorController(behaviorController)
{
    ...
    filteredConversations.bindSortCallback(this, &ConversationModelPimpl::sortConversations);
...
bool
ConversationModelPimpl::sortConversations(const conversation::Info& convA,
                                          const conversation::Info& convB)
{
