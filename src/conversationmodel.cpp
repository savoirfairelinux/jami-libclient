...
ConversationModelPimpl::slotCallEnded(const std::string& callId)
{
    try {
        ...
        addOrUpdateCallMessage(callId, (!call.isOutgoing ? call.peerUri : ""), secs.count());
                                               ...
                                               const std::time_t& duration)
{
    ...
    auto msg = interaction::Info { from, {}, std::time(nullptr), duration,
