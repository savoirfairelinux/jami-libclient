...
public:
    ...
    /**
     * return an optional conversation info from conversation uid.
     * @param conversation uid.
     * @param searchResultIncluded if need to search in contacts and userSearch.
     * @return a conversation info from conversation uid if exists.
     */
    ...
    /**
     * return an optional conversation info from participant uri if exists.
