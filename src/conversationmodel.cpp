...
ConversationModel::ConversationModel(const account::Info& owner,
                                     ...
                                     const BehaviourController& behaviourController)
: QObject()
, pimpl_(std::make_unique<ConversationModelPimpl>(*this, db, callbacksHandler, behaviourController))
, owner(owner)
{
    ...
    try  {
        ...
        switch (call.status) {
            ...
            case call::Status::SEARCHING:
                ...
                emit pimpl_->behaviourController.showIncomingCallView(owner.id, conversation);
                break;
            ...
            case call::Status::IN_PROGRESS:
                ...
                emit pimpl_->behaviourController.showCallView(owner.id, conversation);
                break;
            ...
            default:
                ...
                emit pimpl_->behaviourController.showChatView(owner.id, conversation);
        }
...
ConversationModelPimpl::slotIncomingCall(const std::string& fromId, const std::string& callId)
{
    ...
    emit behaviourController.showIncomingCallView(linked.owner.id, conversation);
}
