    ...
    try  {
        ...
        switch (call.status) {
            ...
            case call::Status::SEARCHING:
                ...
                emit pimpl_->behaviourController.showIncomingCallView(conversation);
                break;
            ...
            case call::Status::IN_PROGRESS:
                ...
                emit pimpl_->behaviourController.showCallView(conversation);
                break;
            ...
            default:
                ...
                emit pimpl_->behaviourController.showChatView(conversation);
        }
...
ConversationModelPimpl::slotIncomingCall(const std::string& fromId, const std::string& callId)
{
    ...
    emit behaviourController.showIncomingCallView(conversation);
}
