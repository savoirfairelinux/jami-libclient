...
{
    if (d_ptr->m_information[LOCAL_FPS].isNull() == false)
...
{
    if (d_ptr->m_information[REMOTE_FPS].isNull() == false)
...
{
    if (d_ptr->m_information[REMOTE_WIDTH].isNull() == false)
...
{
    if (d_ptr->m_information[REMOTE_HEIGHT].isNull() == false)
...
{
    if (d_ptr->m_information[LOCAL_WIDTH].isNull() == false)
...
{
    if (d_ptr->m_information[LOCAL_HEIGHT].isNull() == false)
...
{
    if (d_ptr->m_information[CALL_ID].isNull() == false)
...
{
    if (d_ptr->m_information[LOCAL_VIDEO_CODEC].isNull() == false)
...
{
    if (d_ptr->m_information[LOCAL_AUDIO_CODEC].isNull() == false)
...
{
    if (d_ptr->m_information[REMOTE_VIDEO_CODEC].isNull() == false)
...
{
    if (d_ptr->m_information[REMOTE_AUDIO_CODEC].isNull() == false)
