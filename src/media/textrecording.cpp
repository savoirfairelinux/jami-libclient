            ...
            for (Serializable::Message* m : g->messages) {
                ...
                if (m->id) {
                    ...
                    if (static_cast<DRing::Account::MessageStates>(status) != DRing::Account::MessageStates::UNKNOWN) {
                        if (static_cast<DRing::Account::MessageStates>(status) == DRing::Account::MessageStates::SENT ||
                               static_cast<DRing::Account::MessageStates>(status) == DRing::Account::MessageStates::READ ||
                               static_cast<DRing::Account::MessageStates>(status) == DRing::Account::MessageStates::FAILURE) {
                            m->id = 0;
                        }
