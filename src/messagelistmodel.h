...
public:
    ...
    QString formatTimeString(const std::time_t& timeStamp) const;

    bool contains(const QString& msgId);

    void addHyperlinkInfo(QString messageId, QVariantList hyperlinkInformation);
    int getIndexOfMessage(QString messageId);
