...
public Q_SLOTS: // METHODS
    void startConversation(const QString& accountId) { Q_UNUSED(accountId); }
    ...
    MapStringString getConversations(const QString& accountId)
    {
        Q_UNUSED(accountId);
        return MapStringString();
    }
    MapStringString getConversationRequests(const QString& accountId)
    {
        Q_UNUSED(accountId);
        return MapStringString();
    }
    ...
    MapStringString getConversationMembers(const QString& accountId, const QString& conversationId)
    {
        Q_UNUSED(accountId);
        Q_UNUSED(conversationId);
        return MapStringString();
