...
IF(EXISTS ${CMAKE_INSTALL_PREFIX}/include/jamid/jamid.h)
   SET(ring_INCLUDE_DIRS ${CMAKE_INSTALL_PREFIX}/include/jamid)
ELSEIF(EXISTS ${RING_INCLUDE_DIR}/jamid.h)
   SET(ring_INCLUDE_DIRS ${RING_INCLUDE_DIR})
ELSEIF(EXISTS ${RING_BUILD_DIR}/jamid/jamid.h)
   SET(ring_INCLUDE_DIRS ${RING_BUILD_DIR}/jamid)
ELSE()
